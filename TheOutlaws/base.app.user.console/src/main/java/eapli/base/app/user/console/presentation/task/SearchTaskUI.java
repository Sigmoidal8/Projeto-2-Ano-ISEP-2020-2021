...
import eapli.base.taskmanagement.application.SearchTaskController;
 ...
 * @author migue
 */
public class SearchTaskUI extends AbstractUI {

    private final SearchTaskController theController = new SearchTaskController();

    @Override
    protected boolean doShow() {
        final Iterable<TaskExecution> tasks = this.theController.searchTasks();
        if (tasks == null) {
            System.out.println("Can't search tasks since there is none task of this collaborator\n");
            return false;
        }

        int i = 1;
        System.out.println("Tasks of this Collaborator:");
            ...
            if (option == 1) {
                ...
                switch (option2) {
                    case 1:
                        ...
                        int j = 1;
                        System.out.println("Tasks of this Collaborator Ordered by Priority:");
                    ...
                    case 2:
                        ...
                        int k = 1;
                        System.out.println("Tasks of this Collaborator Ordered by Criticality:");
            ...
            if (option == 2) {
                ...
                switch (option2) {
                    case 1:
                        ...
                        int j = 1;
                        System.out.println("Tasks of this Collaborator Filtered by Priority:");
                        for (TaskExecution t : tasksWithPriority) {
                            System.out.printf("%d- %s\n", j, t);
                            j++;
                        }
                    ...
                    case 2:
                        ...
                        int k = 1;
                        System.out.println("Tasks of this Collaborator Filtered by Criticality:");
                        for (TaskExecution t : tasksWithCriticality) {
                            System.out.printf("%d- %s\n", k, t);
                            k++;
                        }
                    ...
                    case 3:
                        ...
                        int l = 1;
                        System.out.println("Tasks of this Collaborator Filtered by Deadline:");
                        for (TaskExecution t : tasksWithDeadline) {
                            System.out.printf("%d- %s\n", l, t);
                            l++;
                        }
